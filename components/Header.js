            ...
            <header className="header">
              <Container className="header__container">
                <div className="header__left">
                  <span className="header__col-inner">
                    <Link href="/" as="/">
                      <a
                        className={
                          !query.slug ? "logo-link is-active" : "logo-link"
                        }
                      >
                        Design
                        <br />
                ...
                <nav
                  ...
                  onFocus={() => this.toggleMobileMenu({ keepOpen: true })}
                  onBlur={() => this.toggleMobileMenu({ keepClosed: true })}
                >
